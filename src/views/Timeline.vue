          ...
          <div class="flex-row top-row">
            ...
            <div class="description">
              <p>
                ...
                cursus sollicitudin odio nec auctor. Nullam condimentum
                tincidunt turpis at accumsan. Nunc sit amet urna ut nibh
                vulputate gravida quis eget urna. In tincidunt vulputate nulla
                et sollicitudin.
              </p>
              <span class="more">
                <v-icon class="mr-2">slideshow</v-icon>
                <span class="error">Watch Video</span>
              </span>
            </div>
          </div>
          <div class="center-piece">
            ...
            <div class="headings flex-column mt-2">
              <h1 class="intro">
                ...
                <span class="error">1968.</span>
              </h1>
              <h2>
                The disease now has a name, "slim"
              </h2>
              <p>
                "A neighbour and later her boyfriend die in Makindye after
                suffer-ing from a strange disease"<br />
                The disease now has a name people got "Slim." People got thinner
                and died
              </p>
              <p>
